...
int main(int argc, char **argv)
{
  ...
  else
  {
    ...
    seedId = rank;
    auto seed = seeds[seedId];
    std::cout << "gen_costs initialized" << std::endl;
    gen_costs(cost_matrix, y_costs, prob_gen_cycle, seed, pspc, pspc_y, n, K); // Find these functions in f_cutils.cu
    std::cout << "gen_costs finished" << std::endl;
